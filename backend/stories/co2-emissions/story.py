        ...
        return [
            {
                ...
                "options": ['Global Climate Agreements', 'Major Economic and Social Disruptions', 'Technological Breakthroughs', 'Data Errors']
            },
            {
                "id": "overall_trend",
                "text": "Despite temporary dips, what is the 'Predominant Trend' of global CO2 emissions in this dataset?",
                "options": ['Steady Plateau', 'Accelerating Decline', 'Persistent Increase', 'Random Fluctuation']
            }
        ]
