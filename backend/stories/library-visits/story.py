...
class LibraryVisitsStory(BaseStory):
    ...
    def get_voice_line(self, point: Dict, beat: str, stats: Dict) -> str:
        ...
        if beat == "opening":
            return f"COMMENCING LENDING TRACKER: We are analyzing the monthly pulse of New Zealand's library systems. Stability is the goal."
    ...
    def get_quiz_questions(self) -> List[Dict]:
        return [
            ...
            },
            {
                ...
                "options": ['Higher Library Productivity', 'Seasonal Shift in Public Habits', 'Massive Book Deletions', 'Data Collection Error']
            }
        ]
